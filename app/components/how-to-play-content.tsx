...
type Props = { showBackLink?: boolean };

export default function HowToPlayContent({ showBackLink = false }: Props) {
  return (
    <>
      {showBackLink ? (
      ...
      <header className="legal-page__header how-to-play-page__header">
        ...
        <p className="legal-page__intro how-to-play-page__lede">
          Guess the FIFA player in 6 tries.
        </p>
      </header>
      ...
      <div className="legal-page__intro-block how-to-play-page__rules-wrap">
        <ul className="how-to-play-rules">
          ...
          <li>Names are shortened to fit 5 letters, it can be first or last name. Example: RONALDO - RONAL</li>
          <li>
      ...
      >
        <div className="how-to-play-hint-panel">
          <p className="how-to-play-hint-panel__label" id="how-hints">
            Hints
          </p>
          <p className="how-to-play-hint-panel__line">
            <span className="how-to-play-hint-panel__item">🎯 Position</span>
            <span className="how-to-play-hint-panel__dot" aria-hidden>
              ·
            </span>
            <span className="how-to-play-hint-panel__item">🌍 Nationality</span>
            <span className="how-to-play-hint-panel__dot" aria-hidden>
              ·
            </span>
            <span className="how-to-play-hint-panel__item">🏆 League</span>
            <span className="how-to-play-hint-panel__dot" aria-hidden>
              ·
            </span>
            <span className="how-to-play-hint-panel__item">🎂 Age</span>
          </p>
          <p className="how-to-play-hint-panel__sub">
            More unlock with each wrong guess.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div className="how-to-play-example">
          <ExampleRow word="MESSI" index={0} kind="correct" flipDelayMs={0} />
          <p className="how-to-play-example__caption">
            The letter <strong>M</strong> is in the word and in the correct
            spot.
          </p>
        </div>

        <div className="how-to-play-example">
          <ExampleRow word="RONAL" index={1} kind="present" flipDelayMs={320} />
          <p className="how-to-play-example__caption">
        ...
        <div className="how-to-play-example">
          <ExampleRow word="KNATE" index={3} kind="absent" flipDelayMs={640} />
          <p className="how-to-play-example__caption">
