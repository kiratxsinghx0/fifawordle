...
import { players, fetchPlayersFromAPI } from "./fifa-players";
import type { PlayerRow, PlayerHint } from "./fifa-players";
import { fetchPuzzleToday, triggerAutoSetPuzzle as triggerAutoSet } from "../../services/fifa-api";
import type { PuzzleData } from "../../services/fifa-api";
...
const LS_HOW_TO_PLAY_DISMISSED = "fifapuzzle_howToPlayDismissed";
const LS_HOW_TO_PLAY_SEEN = "fifapuzzle_howToPlaySeen";
...
const LS_PUZZLE_CACHE_KEY = "fifapuzzle_cache";
const LS_PUZZLE_FETCHED_DATE_KEY = "fifapuzzle_fetchedDate";
...
const LS_GAME_ID_KEY = "fifapuzzle_gameId";

const LS_GUESS_KEY = "fifapuzzle_guess";
const LS_USER_HAS_PLAYED_KEY = "fifapuzzle_userHasPlayed";
const LS_USER_HAS_PLAYED_VALUE = "yes";
const LS_PUZZLE_ID_KEY = "fifapuzzle_puzzleId";
const LS_SHARE_DISMISSED_PUZZLE_KEY = "fifapuzzle_shareDismissedPuzzleId";
const LS_UNLOCKED_HINTS_KEY = "fifapuzzle_unlockedHints";
const LS_TIMER_ELAPSED_KEY = "fifapuzzle_timerElapsed";
const LS_TIMER_STARTED_KEY = "fifapuzzle_timerStarted";
...
const LS_STATS_KEY = "fifapuzzle_stats";
...
const LS_STATS_RECORDED_KEY = "fifapuzzle_statsRecordedGameId";
