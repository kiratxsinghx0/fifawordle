...
export const iplPlayers: IplPlayerRow[] = [
  ...
  },
  {
    ...
    "hints": [
      ...
      {
        "openingHint": "Loves sleeping so much his teammates joke about it"
      },
      {
        "trivia": [
          "Loves sleeping more than batting practice",
          "Married his childhood crush",
          "Has a daughter he is crazy about",
          "Won IPL five times as captain",
          "Hit the highest score ever in an ODI match",
          "Opens batting and hits sixes like it is nothing"
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    "hints": [
      ...
      {
        "openingHint": "His brother also plays IPL cricket"
      },
      {
        "trivia": [
          "Wore gold chains and rings like a Bollywood hero",
          "Recently got divorced from his actress wife",
          "Was out of cricket for months due to back injury",
          "Led a brand new IPL team and won in their first year",
          "Bowled the last over when India won the World Cup",
          "Hits big sixes for Mumbai Indians"
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    "hints": [
      ...
      {
        "openingHint": "Retired at the peak of his powers and the whole cricket world was shocked"
      },
      {
        "trivia": [
          "Retired when he was still the best batter in the world",
          "Called Mr 360 because he can hit sixes in every direction",
          "Scored the fastest ODI century ever in only 31 balls",
          "Kohli's best partner at RCB and they are very close friends",
          "Could keep wicket and bat at any position in any format",
          "Greatest South African batter and one of the all time greats"
        ]
      }
    ]
  },
