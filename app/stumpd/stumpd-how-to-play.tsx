        ...
        <div className="stumpd-hints-panel">
          <div className="stumpd-hints-panel__header">
            ...
            <p className="stumpd-hints-panel__subtitle">
              You get <strong>3 tokens</strong> — spend 1 token to reveal 1 hint
            </p>
          </div>
          <div className="stumpd-hints-grid">
            <div className="stumpd-hint-chip">
              <span className="stumpd-hint-chip__icon">🎯</span>
              <span className="stumpd-hint-chip__text">Franchise</span>
            </div>
            <div className="stumpd-hint-chip">
              <span className="stumpd-hint-chip__icon">🌍</span>
              <span className="stumpd-hint-chip__text">Country</span>
            </div>
            <div className="stumpd-hint-chip">
              <span className="stumpd-hint-chip__icon">🏏</span>
              <span className="stumpd-hint-chip__text">Playing Style</span>
            </div>
            <div className="stumpd-hint-chip">
              <span className="stumpd-hint-chip__icon">🎂</span>
